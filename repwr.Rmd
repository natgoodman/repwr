...
Bob Reed drew my attention to his post on [how the prior probability that studies are true affects replication success](https://replicationnetwork.com/2018/01/05/reed-a-single-replication-can-make-a-big-difference/). From here I got to his paper [presenting his model](https://onlinelibrary.wiley.com/doi/full/10.1111/1467-8462.12262) and a related post on [why lowering alpha won't help](https://replicationnetwork.com/2017/12/15/reed-why-lowering-alpha-to-0-005-is-unlikely-to-help/).

As I prepared to post this article, a [new systematic replication study](http://www.nature.com/articles/s41562-018-0399-z) "Evaluating the replicability of social science experiments in Nature and Science between 2010 and 2015" appeared in Nature Human Behavior.
