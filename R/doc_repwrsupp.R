...
## 
## Generate figures and tables for repwr.R working paper supplement
##
## This software is open source, distributed under the MIT License. See LICENSE
## file at https://github.com/natgoodman/NewPro/FDR/LICENSE 
##
#################################################################################
## --- Generate Figures and Tables for repwr working paper supplement ---
##### Very rough, initial adaptation of doc_repwr to use doc_resigsupp framework
## sect is which sections to run - for use during development
##   uses prefix matching and all matches run
doc_repwrsupp=function(sect=parent(sect,NULL)) {
  ...
  ## TODO: fix sect.desc.all. copied from doc_resigsupp
  sect.desc.all=
    setNames(c('Exact replication','Exact replication','Exact replication',
               'Inexact replication',
               'Near exact replication','Near exact replication','Small telescopes'),sect.all);
...
##### exact
    ...
    if (sect=='nonzro_exact_roc') {
      ...
      dofig(plotroc,rate.rule='nonzro',xdata=xdata,mesr=mesr.plotdflt);
    }
##### inexact
