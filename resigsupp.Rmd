...
So far so good, but I've only shown data for a few values of $d1$. To see more conditions, Figure S3-3 uses a *rate-vs-rate scatter plot*, inspired by *receiver operating characteristic (ROC)* curves, to plot false negative vs. false positive rates for a large range of conditions. 
