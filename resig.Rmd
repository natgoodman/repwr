---
title: "Systematic Replication Makes a Lot of Mistakes"
...
*Replication seems a sensible way to assess whether a scientific result is right. The intuition is clear: if a result is right, you should get a significant result when repeating the work; if it it's wrong, the result should be non-significant. I assess this intuition across a range of conditions using simulation. For exact replications, all is good, but when replicas diverge from the original studies, significance testing of the replica often gets it wrong. Many caveats apply, but if correct, my results bode ill for large, systematic replication efforts, which typically prioritize uniformity over fidelity to run lots of studies at reasonable cost.*
