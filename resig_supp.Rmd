...
The correlation of the two statistics across the enitre dataset is 0.9997737 and 0.9999019 resp. under the two conditions.  When limiting to small values of $d2_{pop}$, $d2_{pop}\le0.2$, the correlations are 0.9989049 and 0.9995707.
...
Figure S9 shows the values of $n2$ and $d2_{pop}$ that achieve FNR cutoffs of 0.05 and 0.20 for $n1=20$ and $n1=200$.
...
Another point is that the graphs for the two values of $n1$ (20, 200) are nearly identical. I double checked the numbers driving the graphs to make sure I hadn't inadvertently used the same data for both cases. The data for the two cases are almost, but not exactly, the same.
