...
**Caution** The notation *d* is potentially ambiguous.  When used in measures it means $d_{sdz}$, the standardized observed effect size. When used in figures it generally means $d_{pop}$, the population effect size. Sorry.
