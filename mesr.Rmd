...
| $d_{close}$ | `d.close` | minimum acceptable observed effect size in the replica; I use the term "close", because this is the lower bound on effect sizes in the replica that are close enough to the original |
