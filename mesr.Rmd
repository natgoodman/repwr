...
The code uses R's `uniroot` function to solve the equations for $d_{scope}$ and $d_{close}$. The call to `suppressWarnings` is to shut up an annoying warning from `pt` about possibly not attaining full precision.
