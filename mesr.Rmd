...
### Measures and statistics computed on individual studies
  ...
  - *d1*, *d2* (standardized observed effect size, aka *Cohen’s d*, for the two studies): mean of *group1* minus the mean of *group0* divided by the pooled standard deviation of the two groups.
<br/>
The standard formula for pooled standard deviation when the two groups have the same sample size $n$ and standard deviations $sd0$ and $sd1$ is 
$$\begin{aligned}
...
```
  ...
  - *pval1*, *pval2* (p-value from t-distribution of *d1*, *d2*): computed from *n*, *d1*, *d2* by the standard formulae
$$\begin{aligned}
t&=d\sqrt{n^2/2n} \\
