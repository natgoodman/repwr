...
Notation: $w.meta$, $d.meta$. These are the inverse variance weight and weighted effect size of an individual study. 

Definition: The variance in question is the sampling variance of the estimated effect size ($d.sdz$), not the variance of the data! The sampling distribution of $d.sdz$ is a non-central t-distribution centered on $d.sdz$ and with 

with sd=sd_d2t(n,d.sdz)
- [+] the estimated meta d.sdz apparently follows a normal distribution with sd as calculated in the code
