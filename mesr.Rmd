...
Meaning: standardized observed effect sizes, aka *Cohen’s d*, for the two studies
...
P-value from t-distribution of *d1*, *d2*: computed from *n*, *d1*, *d2* by the standard formulae
$$\begin{aligned}
t&=d\sqrt{n^2/2n} \\
