...
These functions use the identities $d=t\sqrt{2n/n^2}$ and $t=d\sqrt{n^2/2n}$ to convert between standardized effect sizes ($d$) and t-statistics ($t$) thes use base R's `pt` functions to convert t-statistics into p-values.
