...
The values computed before the simulation are Uri Simonsohn's small telescopes thresholds, my extension to Uri's method that takes into account the observed effect size, and con


Values computed before the simulation cannot depend on the data, of course. 
