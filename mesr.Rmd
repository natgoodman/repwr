...
<br/>
**Specialized notation for small telescope thresholds**

| math | code | meaning |
| ------- | ------- | -------------------------------------------------------- |
| $pwr$ | `scope.pwr` | required power of original study; Uri fixes this at 33% |
| $d_{pwr}$ | `d.pwr` | minimum population effect size that would confer $pwr$ power to the original study; Uri calls this $d_{33\%}$ |
| $d_{scope}$ | `d.scope` | minimum acceptable observed effect size in the replica |
